...
function Chebyshev(n::Int, T::Type{<:AbstractFloat} = Float64)
    ...
    PolyBasis{:chebyshev, typeof(f0), typeof(f1), typeof(a0),
        typeof(a1), typeof(a2), typeof(f_weight), typeof(f_norm)}(
        n, f0, f1, a0, a1, a2, f_weight, f_norm)
end
...
function Legendre(n::Int, T::Type{<:AbstractFloat} = Float64)
    ...
    PolyBasis{:legendre, typeof(f0), typeof(f1), typeof(a0),
        typeof(a1), typeof(a2), typeof(f_weight), typeof(f_norm)}(
        n, f0, f1, a0, a1, a2, f_weight, f_norm)
end
...
function Laguerre(n::Int, T::Type{<:AbstractFloat} = Float64)
    ...
    PolyBasis{:laguerre, typeof(f0), typeof(f1), typeof(a0),
        typeof(a1), typeof(a2), typeof(f_weight), typeof(f_norm)}(
        n, f0, f1, a0, a1, a2, f_weight, f_norm)
end
...
function Hermite(n::Int; T::Type{<:AbstractFloat} = Float64)
    ...
    PolyBasis{:hermite, typeof(f0), typeof(f1), typeof(a0), typeof(a1),
        typeof(a2), typeof(f_weight), typeof(f_norm)}(
        n, f0, f1, a0, a1, a2, f_weight, f_norm)
end
...
function Hermite_hat(n::Int; T::Type{<:AbstractFloat} = Float64)
    ...
    PolyBasis{:hermite_hat, typeof(f0), typeof(f1), typeof(a0),
        typeof(a1), typeof(a2), typeof(f_weight), typeof(f_norm)}(
        n, f0, f1, a0, a1, a2, f_weight, f_norm)
end
